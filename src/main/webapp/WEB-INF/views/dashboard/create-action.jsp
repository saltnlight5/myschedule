...
<div class="success">
A new scheduler service, <a href="${ mainPath }/dashboard/switch-scheduler?name=${ data.schedulerService.name }">${ data.schedulerService.name }</a>, has been successfully created.
</div>
